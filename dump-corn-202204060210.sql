...
-- Started on 2022-04-06 02:10:48
...
--
-- TOC entry 7 (class 2615 OID 279347)
...
--
-- TOC entry 202 (class 1259 OID 279348)
-- Name: city_connection; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.city_connection (
    id bigint NOT NULL,
    city_left_id bigint NOT NULL,
    city_right_id bigint NOT NULL,
    ...
    CONSTRAINT recurrence_city_ids CHECK ((city_left_id <> city_right_id))
);


ALTER TABLE public.city_connection OWNER TO postgres;

--
-- TOC entry 2898 (class 0 OID 0)
-- Dependencies: 202
-- Name: TABLE city_connection; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.id; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.nominal_distance; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.alternative_distance; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.federal_expressway; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.federal_road_regular; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.regional_expressway; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.regional_road_regular; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.local_road; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.obstacles; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.coefficient_road_infrastructure; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.coefficient_detour; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.coefficient_obstacles; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.coefficient_exceeding_distance; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 202
-- Name: COLUMN city_connection.coefficient_accessibility; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 226 (class 1255 OID 279352)
-- Name: calc_coefficients_road_infrastructure(public.city_connection); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.calc_coefficients_road_infrastructure(r public.city_connection) OWNER TO postgres;

--
-- TOC entry 227 (class 1255 OID 279353)
-- Name: calc_sum_of_dealerships(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.calc_sum_of_dealerships(sum_machine integer) OWNER TO postgres;

--
-- TOC entry 228 (class 1255 OID 279354)
-- Name: text_index(bigint, bigint); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.text_index(city_left_id bigint, city_right_id bigint) RETURNS text
	...
	begin
		...
		RETURN concat(LEAST(city_left_id, city_right_id), '_',  GREATEST(city_left_id, city_right_id));
...
ALTER FUNCTION public.text_index(city_left_id bigint, city_right_id bigint) OWNER TO postgres;

--
-- TOC entry 229 (class 1255 OID 279355)
-- Name: trigger_calc_coefficients_road_infrastructure(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.trigger_calc_coefficients_road_infrastructure() OWNER TO postgres;

--
-- TOC entry 230 (class 1255 OID 279356)
-- Name: trigger_calc_sum_of_dealerships(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.trigger_calc_sum_of_dealerships() OWNER TO postgres;

--
-- TOC entry 231 (class 1255 OID 279357)
-- Name: trigger_calc_sum_of_machine(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.trigger_calc_sum_of_machine() OWNER TO postgres;

--
-- TOC entry 232 (class 1255 OID 279358)
-- Name: update_coefficient_road_infrastructure(bigint); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.update_coefficient_road_infrastructure(id_i bigint) OWNER TO postgres;

--
-- TOC entry 203 (class 1259 OID 279359)
...
-- Dependencies: 203
-- Name: COLUMN city.id; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 203
-- Name: COLUMN city.full_name; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 203
-- Name: COLUMN city.population; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 203
-- Name: COLUMN city.machine; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 203
-- Name: COLUMN city.region_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 213 (class 1259 OID 279466)
-- Name: city_by_conection_view; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.city_by_conection_view AS
 SELECT sel.id_city,
    sel.full_name,
    sel.id,
    sel.city_left_id,
    sel.city_right_id,
    sel.nominal_distance,
    sel.alternative_distance,
    sel.federal_expressway,
    sel.federal_road_regular,
    sel.regional_expressway,
    sel.regional_road_regular,
    sel.local_road,
    sel.obstacles,
    sel.coefficient_road_infrastructure,
    sel.coefficient_detour,
    sel.coefficient_obstacles,
    sel.coefficient_exceeding_distance,
    sel.coefficient_accessibility
   FROM ( SELECT c.id AS id_city,
            c.full_name,
            cc.id,
            cc.city_left_id,
            cc.city_right_id,
            cc.nominal_distance,
            cc.alternative_distance,
            cc.federal_expressway,
            cc.federal_road_regular,
            cc.regional_expressway,
            cc.regional_road_regular,
            cc.local_road,
            cc.obstacles,
            cc.coefficient_road_infrastructure,
            cc.coefficient_detour,
            cc.coefficient_obstacles,
            cc.coefficient_exceeding_distance,
            cc.coefficient_accessibility
           FROM (public.city c
             LEFT JOIN public.city_connection cc ON ((c.id = cc.city_left_id)))
        UNION
         SELECT c.id AS id_city,
            c.full_name,
            cc.id,
            cc.city_left_id,
            cc.city_right_id,
            ...
            cc.coefficient_accessibility
           FROM (public.city c
             LEFT JOIN public.city_connection cc ON ((c.id = cc.city_right_id)))) sel
  WHERE (sel.id IS NOT NULL);


ALTER TABLE public.city_by_conection_view OWNER TO postgres;

--
-- TOC entry 204 (class 1259 OID 279362)
-- Name: city_connection_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.city_connection_id_seq OWNER TO postgres;

--
-- TOC entry 2919 (class 0 OID 0)
-- Dependencies: 204
-- Name: city_connection_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- TOC entry 205 (class 1259 OID 279364)
...
--
-- TOC entry 211 (class 1259 OID 279427)
-- Name: group_city; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.group_city (
    id bigint NOT NULL,
    index_group bigint NOT NULL
);


ALTER TABLE public.group_city OWNER TO postgres;

--
-- TOC entry 2921 (class 0 OID 0)
-- Dependencies: 211
-- Name: TABLE group_city; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.group_city IS 'подгруппы городов в области';


--
-- TOC entry 2922 (class 0 OID 0)
-- Dependencies: 211
-- Name: COLUMN group_city.id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.group_city.id IS 'ID';


--
-- TOC entry 2923 (class 0 OID 0)
-- Dependencies: 211
-- Name: COLUMN group_city.index_group; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.group_city.index_group IS 'номер подгруппы городов в области';


--
-- TOC entry 212 (class 1259 OID 279462)
-- Name: group_city_view; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.group_city_view AS
SELECT
    NULL::bigint AS index_group,
    NULL::bigint AS mahine;


ALTER TABLE public.group_city_view OWNER TO postgres;

--
-- TOC entry 210 (class 1259 OID 279425)
...
ALTER SEQUENCE public.group_id_seq OWNED BY public.group_city.id;


--
-- TOC entry 209 (class 1259 OID 279416)
...
--
-- TOC entry 208 (class 1259 OID 279414)
...
--
-- TOC entry 206 (class 1259 OID 279366)
...
-- Dependencies: 206
-- Name: COLUMN region.full_name; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 206
-- Name: COLUMN region.central_city_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 206
-- Name: COLUMN region.machine; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 206
-- Name: COLUMN region.dealerships; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 207 (class 1259 OID 279372)
-- Name: region_column1_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.region_column1_seq OWNER TO postgres;

--
-- TOC entry 2931 (class 0 OID 0)
-- Dependencies: 207
-- Name: region_column1_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2730 (class 2604 OID 279374)
...
--
-- TOC entry 2728 (class 2604 OID 279375)
-- Name: city_connection id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2733 (class 2604 OID 279430)
-- Name: group_city id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.group_city ALTER COLUMN id SET DEFAULT nextval('public.group_id_seq'::regclass);


--
-- TOC entry 2732 (class 2604 OID 279419)
...
--
-- TOC entry 2731 (class 2604 OID 279376)
...
--
-- TOC entry 2884 (class 0 OID 279359)
-- Dependencies: 203
-- Data for Name: city; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.city VALUES (3, 'с. Александров Гай', 13749, 0, 1, NULL);
INSERT INTO public.city VALUES (4, 'г. Аркадак', 11516, 19, 1, NULL);
INSERT INTO public.city VALUES (5, 'г. Аткарск', 24125, 11, 1, NULL);
INSERT INTO public.city VALUES (6, 'п. Базарный Карабулак', 9407, 3, 1, NULL);
INSERT INTO public.city VALUES (7, 'г. Балаково', 187523, 10, 1, NULL);
INSERT INTO public.city VALUES (8, 'г. Балашов', 75773, 17, 1, NULL);
INSERT INTO public.city VALUES (9, 'с. Балтай', 5184, 0, 1, NULL);
INSERT INTO public.city VALUES (10, 'г. Вольск', 61943, 4, 1, NULL);
INSERT INTO public.city VALUES (11, 'с. Воскресенское', 4489, 0, 1, NULL);
INSERT INTO public.city VALUES (12, 'п. Дергачи', 7704, 2, 1, NULL);
INSERT INTO public.city VALUES (13, 'п. Духовницкое', 4818, 9, 1, NULL);
INSERT INTO public.city VALUES (14, 'п. Екатериновка', 5753, 11, 1, NULL);
INSERT INTO public.city VALUES (15, 'г. Ершов', 18796, 8, 1, NULL);
INSERT INTO public.city VALUES (16, 'с. Ивантеевка', 5412, 1, 1, NULL);
INSERT INTO public.city VALUES (17, 'г. Калининск', 15508, 9, 1, NULL);
INSERT INTO public.city VALUES (18, 'г. Красноармейск', 22319, 1, 1, NULL);
INSERT INTO public.city VALUES (19, 'г. Красный Кут', 14130, 2, 1, NULL);
INSERT INTO public.city VALUES (20, 'п. Горный', 4565, 25, 1, NULL);
INSERT INTO public.city VALUES (21, 'п. Лысые Горы', 7074, 0, 1, NULL);
INSERT INTO public.city VALUES (22, 'г. Маркс', 30743, 11, 1, NULL);
INSERT INTO public.city VALUES (23, 'п. Новые Бурасы', 5796, 4, 1, NULL);
INSERT INTO public.city VALUES (24, 'г. Новоузенск', 15122, 0, 1, NULL);
INSERT INTO public.city VALUES (25, 'п. Озинки', 8106, 1, 1, NULL);
INSERT INTO public.city VALUES (26, 'с. Перелюб', 4934, 11, 1, NULL);
INSERT INTO public.city VALUES (27, 'г. Петровск', 28237, 2, 1, NULL);
INSERT INTO public.city VALUES (28, 'с. Питерка', 5127, 0, 1, NULL);
INSERT INTO public.city VALUES (38, 'г. Хвалынск', 12288, 0, 1, NULL);
INSERT INTO public.city VALUES (29, 'г. Пугачев', 40656, 22, 1, NULL);
INSERT INTO public.city VALUES (30, 'п. Ровное', 4305, 0, 1, NULL);
INSERT INTO public.city VALUES (31, 'п. Романовка', 6308, 11, 1, NULL);
INSERT INTO public.city VALUES (32, 'г. Ртищево', 38364, 4, 1, NULL);
INSERT INTO public.city VALUES (33, 'п. Самойловка', 6489, 17, 1, NULL);
INSERT INTO public.city VALUES (34, 'п. Степное', 11603, 6, 1, NULL);
INSERT INTO public.city VALUES (35, 'п. Татищево', 7431, 3, 1, NULL);
INSERT INTO public.city VALUES (36, 'п. Турки', 5486, 8, 1, NULL);
INSERT INTO public.city VALUES (2, 'г. Энгельс', 227049, 4, 1, NULL);
INSERT INTO public.city VALUES (37, 'п. Мокроус', 6037, 0, 1, NULL);
INSERT INTO public.city VALUES (1, 'г. Саратов', 838042, 1, 1, 1);


--
-- TOC entry 2883 (class 0 OID 279348)
-- Dependencies: 202
-- Data for Name: city_connection; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2892 (class 0 OID 279427)
-- Dependencies: 211
-- Data for Name: group_city; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.group_city VALUES (1, 1);
INSERT INTO public.group_city VALUES (2, 2);
INSERT INTO public.group_city VALUES (3, 3);


--
-- TOC entry 2890 (class 0 OID 279416)
-- Dependencies: 209
...
--
-- TOC entry 2887 (class 0 OID 279366)
-- Dependencies: 206
...
-- Dependencies: 204
-- Name: city_connection_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 207
-- Name: region_column1_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2735 (class 2606 OID 279378)
-- Name: city_connection city_connection_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2738 (class 2606 OID 279380)
...
--
-- TOC entry 2740 (class 2606 OID 279382)
-- Name: city city_un; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2746 (class 2606 OID 279432)
-- Name: group_city group_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.group_city
    ADD CONSTRAINT group_pk PRIMARY KEY (id);


--
-- TOC entry 2744 (class 2606 OID 279424)
...
--
-- TOC entry 2742 (class 2606 OID 279384)
...
--
-- TOC entry 2736 (class 1259 OID 279385)
-- Name: city_connection_un_collision; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX city_connection_un_collision ON public.city_connection USING btree (public.text_index(city_left_id, city_right_id));


--
-- TOC entry 2881 (class 2618 OID 279465)
-- Name: group_city_view _RETURN; Type: RULE; Schema: public; Owner: postgres
--

CREATE OR REPLACE VIEW public.group_city_view AS
 SELECT gc.index_group,
    sum(c.machine) AS mahine
   FROM (public.group_city gc
     LEFT JOIN public.city c ON ((c.group_id = gc.id)))
  GROUP BY gc.id;


--
-- TOC entry 2753 (class 2620 OID 279386)
-- Name: city update_city; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2752 (class 2620 OID 279387)
-- Name: city_connection update_city_connection; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2754 (class 2620 OID 279388)
-- Name: region update_region; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2747 (class 2606 OID 279389)
-- Name: city_connection city_connection_fk_left; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.city_connection
    ADD CONSTRAINT city_connection_fk_left FOREIGN KEY (city_left_id) REFERENCES public.city(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- TOC entry 2748 (class 2606 OID 279394)
-- Name: city_connection city_connection_fk_right; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.city_connection
    ADD CONSTRAINT city_connection_fk_right FOREIGN KEY (city_right_id) REFERENCES public.city(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- TOC entry 2749 (class 2606 OID 279399)
...
--
-- TOC entry 2750 (class 2606 OID 279453)
-- Name: city city_fk_gr; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.city
    ADD CONSTRAINT city_fk_gr FOREIGN KEY (group_id) REFERENCES public.group_city(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- TOC entry 2751 (class 2606 OID 279404)
-- Name: region region_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2022-04-06 02:10:48
